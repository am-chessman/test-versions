        ...
        <>
            <header className="header">
                ...
                <div className="hdr-content">
                    ...
                    <div className="header-btns">
                        ...
                        <a href="https://www.foodora.se/en/restaurant/zbmp/ikigai-sushi" className="hdr-a" target="_blank" rel="noreferrer">    
            ...
            <section className="odr-section">
                <div className="odr-div menu">
                    <h2>Våra Menyer</h2>
                    <a href="/menu#menu-section" rel="noreferrer">Varm Rätter 🍵</a>
                    <a href="/menu#menu-section" rel="noreferrer">Poké Bowl 🥗</a>
                    <a href="/menu#menu-section" rel="noreferrer">Sushi 🍣</a>
                </div>
                ...
                <div className="odr-div contact">
                    ...
                    <div className="contacts-info last">
                        <h3>Adress:</h3>
                        <a href="https://www.google.com/maps/place/Stationsgatan+2c,+195+40+M%C3%A4rsta/@59.6283521,17.8571806,17z/data=!3m1!4b1!4m6!3m5!1s0x465fbc17139b2471:0xfedfe82cd3d1cddf!8m2!3d59.6283494!4d17.8597555!16s%2Fg%2F11t2q5h8lj?entry=ttu" target="_blank" rel="noreferrer">
